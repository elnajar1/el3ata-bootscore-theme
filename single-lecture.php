              ...
              <?php
                ...
                if( stripos($details['url'],'youtu') === false){
                 ...
                 <?php
                  ...
                  ?>
                  <iframe width="560" height="315" src="http://www.youtube.com/v/<?php echo $youtube_video_id[0]  ?>" title="<?php the_title(); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  <?php
                }
              ?>
            </div>
